...
public class Square {
	...
	private static Mat findLargestRectangle(Mat original_image) {
	    ...
	    //Imgproc.warpPerspective(original_image, imgSource, perspectiveTransform, new Size(300,300));
	    
	    Highgui.imwrite(MatchingMethod.screenInfoScreen+ "Test1.png", original_image);
	...
	public static void main(String[] args){
		...
		//getSquare(Highgui.imread(MatchingMethod.screenInfoScreen+ "Test.png"));
	}
